...
void ordenaClientes (Cliente clientes[], int qtdClientes)
{
    int i, k;
    Cliente aux;
...
void exibeZerados (Cliente clientes[], int qtdClientes, float matrizValores[][3])
{
    ...
    printf ("\nClientes com todas as aplicações zeradas: \n");
...
float processarMovimentacoes (Movimentacoes mov[], Cliente clientes[], float matrizValores[][3], int qtdClientes)
{
    ...
    do {
        ...
        if (qtdErro > 0) {
        printf("*Operação não realizada*: Cliente %d, Operação %c, Investimento %d, Valor %.2f\n",
...
int main()
{
    ...
    ordenaClientes (clientes, qtdClientes);
